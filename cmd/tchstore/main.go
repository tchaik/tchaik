...
/*
tchstore is a tool to create a remote store for tchaik files, including index, media and artwork files.
...
By default the artwork store will try to:
...
If the artwork cache is enabled, then all fetched artwork will be cached on the first access.
