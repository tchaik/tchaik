...
// Filter combs through the list of paths, returning paths which are checklist items (as
...
// Filter combs through the list of paths, return paths which are/contain checklist items
